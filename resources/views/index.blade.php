...
@section('content')
    ...
    <section id="hero" class="hero section">
      ...
      <img src="{{secure_asset('assets/img/hero-bg-abstract.jpg')}}" alt="" data-aos="fade-in" class="">
          ...
          <div class="col-lg-6 col-md-6">
            <div class="row justify-content-center">
              <div class="col-lg-12 col-md-12">
                ...
                <img src="{{secure_asset('assets/img/dataset-cover.jpg')}}" class="img-fluid mb-3" alt="">
          ...
          <div class="col-lg-3 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="200">
            <div class="team-member">
              <div class="member-img">
                <img src="{{secure_asset('assets/img/team/picture_11.jpg')}}" class="img-fluid" alt="">
                <div class="social">
